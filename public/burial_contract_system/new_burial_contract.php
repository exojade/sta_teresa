    ...
    <div class="box box-solid">
            ...
            <div class="row">
              ...
              <div class="form-group">
                  ...
                  <input type="text" required name="barangay"  class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              <div class="col-md-3">
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" required name="zipcode" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="text" required name="client_relationship" required class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Barangay *</label>
                  <input type="text" required name="deceased_barangay"  class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              <div class="col-md-3">
              <div class="form-group">
              ...
              <div class="form-group">
                  <label for="exampleInputEmail1">Zipcode *</label>
                  <input type="text" required name="deceased_zipcode" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" required name="death_address" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
